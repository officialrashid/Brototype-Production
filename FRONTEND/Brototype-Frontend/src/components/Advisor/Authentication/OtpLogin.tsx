...
const AdvisorOtpPage: FunctionComponent = () => {
    ...
    const otpData: OtpData = useSelector((state: RootState) => state.advisor);
  ...
  console.log(otpData,"bfjvhdfgjgdfjghdfjgdfhjhgdhgdfjhgdfj123456789000000000");
        ...
        advisorIdRef.current = otpData?.advisorData?.advisorId;
            ...
            if (code.length === 6) {
                window.confirmationResult.confirm(code).then((result: any) => {
                    ...
                    const advisorData: any = {
                        advisorId: advisorIdRef.current,
