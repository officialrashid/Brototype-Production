...
const EditForm=({isVisible ,onClose,batchRecord})=>{
...
<div className="fixed inset-0 z-10 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center   overflow-y-scroll overflow-hidden ">
