...
const StudentOtpPage: FunctionComponent = () => {
  ...
  console.log(otpData?.studentData?.batchId,"bfjvhdfgjgdfjghdfjgdfhjhgdhgdfjhgdfj123456789000000000");
    ...
    const onSignup = async () => {
        ...
        try {
            ...
            console.log(error.message,"error message otp login");
            console.log(error,"full log error  otp login");
